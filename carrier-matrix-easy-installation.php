...
class CarrierMatrixEasyInstallation {
    ...
    public function carrier_matrix_shortcode_handler($atts) {
        ...
        return $this->carrier_matrix_handler_callback($a['form'], $a['results'], $a['button_text']);
    ...
    public function carrier_matrix_handler_callback($form, $results, $button_text) {
        ...
        if (!empty($form)) {
            ...
            echo '<carrier-matrix results="'.$results.'"></carrier-matrix>';
        }
        return ob_get_clean();
    }
